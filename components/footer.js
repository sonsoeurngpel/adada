const navigation = {
    social: [
      {
        id: 1,
        name: 'Twitter',
        href: 'https://twitter.com/AvaxDex',
        icon: (props) => (
      ...
      },
      {
        ...
        name: 'Discord',
        href: 'https://discord.gg/jRg7vcxUWx',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      },
      {
        id: 3,
        name: 'Instagram',
        href: 'https://instagram.com/avaxdex',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    footerText: [
      {
        id: 4,
        text: '2022 Adex Story NFTs. All rights reserved.',
      }
    ],
  }
    ...
    return (
      <footer>
        <div className="max-w-7xl mx-auto py-8 px-4 overflow-hidden sm:px-6 lg:px-8">
          <div className="mt-1 flex justify-center space-x-12">
          {navigation.social.map((item) => (
              <a key={item.id} href={item.href} className="text-pale-yellow hover:text-gray-500">
          ...
          <p key={item.id} className="mt-8 text-center text-pale-yellow font-justanotherhand text-5xl">&copy; {item.text}</p>
          ))}
          </div>
        </div>
      </footer>
